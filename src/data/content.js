import { BadgeIndianRupee, CircleUserRound, EyeOff, FileWarning, MessagesSquare, ShieldAlert, } from 'lucide-react';
...
export const suspectReports = {
    phone: {
        '9876543210': {
            ...
            summary: 'This number appears across multiple complaints involving payment collection and impersonation.',
            reports: 142,
    ...
    upi: {
        'refunddesk@upi': {
            ...
            summary: 'Reports link this UPI ID with fake refund and remote-access scams.',
            reports: 86,
    ...
    email: {
        'support-kys@example.com': {
            ...
            summary: 'This sender imitates a service address and appears in phishing reports.',
            reports: 19,
    ...
    url: {
        'https://secure-update.example': {
            ...
            summary: 'This domain is flagged for imitating a security-update page and collecting login details.',
            reports: 61,
