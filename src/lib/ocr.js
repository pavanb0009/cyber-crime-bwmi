...
function layerTextFromPage(items) {
    return items
...
async function renderPageToCanvas(page) {
    ...
    if (!context)
        throw new Error('This browser cannot render the PDF page.');
...
async function extractFromImage(file, onProgress) {
    ...
    if (!text)
        throw new Error('No readable text was found in this image. Try a clearer photo.');
